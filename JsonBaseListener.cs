...
public partial class JsonBaseListener : IJsonListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterJsonpair([NotNull] JsonParser.JsonpairContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="JsonParser.jsonpair"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitJsonpair([NotNull] JsonParser.JsonpairContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="JsonParser.seplist_of_comma_and_json"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterSeplist_of_comma_and_json([NotNull] JsonParser.Seplist_of_comma_and_jsonContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="JsonParser.seplist_of_comma_and_json"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitSeplist_of_comma_and_json([NotNull] JsonParser.Seplist_of_comma_and_jsonContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="JsonParser.seplist_of_comma_and_json_pair"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterSeplist_of_comma_and_json_pair([NotNull] JsonParser.Seplist_of_comma_and_json_pairContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="JsonParser.seplist_of_comma_and_json_pair"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitSeplist_of_comma_and_json_pair([NotNull] JsonParser.Seplist_of_comma_and_json_pairContext context) { }
	/// <summary>
